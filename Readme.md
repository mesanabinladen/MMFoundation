...
To keep the library recognizable and familiar to people coming from Apple’s ecosystem, the class and object names use the same conventions as Foundation, but with NS replaced by MM.
...
Similarly, features such as autorelease pools or automatic reference counting will not be implemented. Memory management will remain completely under the control of the programmer, in a pure C style.
